...
int main() {
  ...
  */
  ...
  // view (fov = 26, quat = {0.431384,-0.216693,-0.317091,0.816338},
	// tx = 1, ty = 0, bg = {0.3,0.4,0.6}, width = 1000,
	// height = 1000, samples = 3);
  view (fov = 26, theta = -0.9, phi = 0.5,
	tx = 0, ty = 0, bg = {0.3,0.4,0.6}, width = 1000,
	height = 1000, samples = 3);
  box();
  draw_vof ("f");
  cells();
