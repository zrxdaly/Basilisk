#line 91 "/home/dai/software/basilisk/src/navier-stokes/centered.h"
...
#line 90 "/home/dai/software/basilisk/src/navier-stokes/centered.h"

if (!is_constant(alpha.x) && !is_constant(a.x) && !is_constant(fm.x) && !is_constant(rho) && !is_constant(cm)) {
#undef val_alpha_x
...
#line 91
return  neumann ((val_alpha_x(alpha.x,(ig > 0 ? 1 : ig < 0 ? -1 : 0),(jg > 0 ? 1 : jg < 0 ? -1 : 0),0) ? val_a_x(a.x,(ig > 0 ? 1 : ig < 0 ? -1 : 0),(jg > 0 ? 1 : jg < 0 ? -1 : 0),0)*val_fm_x(fm.x,(ig > 0 ? 1 : ig < 0 ? -1 : 0),(jg > 0 ? 1 : jg < 0 ? -1 : 0),0)/val_alpha_x(alpha.x,(ig > 0 ? 1 : ig < 0 ? -1 : 0),(jg > 0 ? 1 : jg < 0 ? -1 : 0),0) : val_a_x(a.x,(ig > 0 ? 1 : ig < 0 ? -1 : 0),(jg > 0 ? 1 : jg < 0 ? -1 : 0),0)*val_rho(rho,0,0,0)/(val_cm(cm,0,0,0) + 1e-30))); }
if (is_constant(alpha.x) && !is_constant(a.x) && !is_constant(fm.x) && !is_constant(rho) && !is_constant(cm)) {
...
#line 92 "/home/dai/software/basilisk/src/navier-stokes/centered.h"
...
#define coarse_cm(a,i,j,k) coarse(a,i,j,k)
#line 92
return  neumann (- (val_alpha_x(alpha.x,0,0,0) ? val_a_x(a.x,0,0,0)*val_fm_x(fm.x,0,0,0)/val_alpha_x(alpha.x,0,0,0) : val_a_x(a.x,0,0,0)*val_rho(rho,0,0,0)/(val_cm(cm,0,0,0) + 1e-30))); }
if (is_constant(alpha.x) && !is_constant(a.x) && !is_constant(fm.x) && !is_constant(rho) && !is_constant(cm)) {
const struct { double x, y; } _const_alpha = {_constant[alpha.x.i -_NVARMAX], _constant[alpha.y.i - _NVARMAX]};
NOT_UNUSED(_const_alpha);
#undef val_alpha_x
...
#line 92
return  neumann_homogeneous(); } return 0.; }
#line 101 "/home/dai/software/basilisk/src/navier-stokes/centered.h"
...
#line 100 "/home/dai/software/basilisk/src/navier-stokes/centered.h"
...
#define coarse_cm(a,i,j,k) coarse(a,i,j,k)
#line 101
return  neumann ((val_alpha_y(alpha.y,(ig > 0 ? 1 : ig < 0 ? -1 : 0),(jg > 0 ? 1 : jg < 0 ? -1 : 0),0) ? val_a_y(a.y,(ig > 0 ? 1 : ig < 0 ? -1 : 0),(jg > 0 ? 1 : jg < 0 ? -1 : 0),0)*val_fm_y(fm.y,(ig > 0 ? 1 : ig < 0 ? -1 : 0),(jg > 0 ? 1 : jg < 0 ? -1 : 0),0)/val_alpha_y(alpha.y,(ig > 0 ? 1 : ig < 0 ? -1 : 0),(jg > 0 ? 1 : jg < 0 ? -1 : 0),0) : val_a_y(a.y,(ig > 0 ? 1 : ig < 0 ? -1 : 0),(jg > 0 ? 1 : jg < 0 ? -1 : 0),0)*val_rho(rho,0,0,0)/(val_cm(cm,0,0,0) + 1e-30))); }
if (is_constant(alpha.x) && !is_constant(a.x) && !is_constant(fm.x) && !is_constant(rho) && !is_constant(cm)) {
const struct { double x, y; } _const_alpha = {_constant[alpha.x.i -_NVARMAX], _constant[alpha.y.i - _NVARMAX]};
NOT_UNUSED(_const_alpha);
#undef val_alpha_x
...
#define coarse_cm(a,i,j,k) _const_cm
#line 101
return  neumann ((val_alpha_y(alpha.y,(ig > 0 ? 1 : ig < 0 ? -1 : 0),(jg > 0 ? 1 : jg < 0 ? -1 : 0),0) ? val_a_y(a.y,(ig > 0 ? 1 : ig < 0 ? -1 : 0),(jg > 0 ? 1 : jg < 0 ? -1 : 0),0)*val_fm_y(fm.y,(ig > 0 ? 1 : ig < 0 ? -1 : 0),(jg > 0 ? 1 : jg < 0 ? -1 : 0),0)/val_alpha_y(alpha.y,(ig > 0 ? 1 : ig < 0 ? -1 : 0),(jg > 0 ? 1 : jg < 0 ? -1 : 0),0) : val_a_y(a.y,(ig > 0 ? 1 : ig < 0 ? -1 : 0),(jg > 0 ? 1 : jg < 0 ? -1 : 0),0)*val_rho(rho,0,0,0)/(val_cm(cm,0,0,0) + 1e-30))); } return 0.; } static double _boundary2_homogeneous (Point point, Point neighbor, scalar _s, void * data) { int ig = neighbor.i - point.i;  if (ig == 0) ig = _attribute[_s.i].d.x;  NOT_UNUSED(ig); int jg = neighbor.j - point.j;  if (jg == 0) jg = _attribute[_s.i].d.y;  NOT_UNUSED(jg); POINT_VARIABLES; 
#line 100 "/home/dai/software/basilisk/src/navier-stokes/centered.h"
...
#line 101
return  neumann_homogeneous(); } return 0.; }
#line 102 "/home/dai/software/basilisk/src/navier-stokes/centered.h"
...
#define coarse_cm(a,i,j,k) coarse(a,i,j,k)
#line 102
return  neumann (- (val_alpha_y(alpha.y,0,0,0) ? val_a_y(a.y,0,0,0)*val_fm_y(fm.y,0,0,0)/val_alpha_y(alpha.y,0,0,0) : val_a_y(a.y,0,0,0)*val_rho(rho,0,0,0)/(val_cm(cm,0,0,0) + 1e-30))); }
if (is_constant(alpha.x) && !is_constant(a.x) && !is_constant(fm.x) && !is_constant(rho) && !is_constant(cm)) {
const struct { double x, y; } _const_alpha = {_constant[alpha.x.i -_NVARMAX], _constant[alpha.y.i - _NVARMAX]};
NOT_UNUSED(_const_alpha);
#undef val_alpha_x
...
#line 60 "wall_heat.c"
return  dirichlet(0.1*log((y+0.1)/0.1)); return 0.; } static double _boundary7_homogeneous (Point point, Point neighbor, scalar _s, void * data) { int ig = neighbor.i - point.i;  if (ig == 0) ig = _attribute[_s.i].d.x;  NOT_UNUSED(ig); int jg = neighbor.j - point.j;  if (jg == 0) jg = _attribute[_s.i].d.y;  NOT_UNUSED(jg); POINT_VARIABLES; 
#line 60 "wall_heat.c"
return  dirichlet_homogeneous(); return 0.; }
#line 63 "wall_heat.c"
...
#line 62 "wall_heat.c"
return  dirichlet (0.); return 0.; } static double _boundary8_homogeneous (Point point, Point neighbor, scalar _s, void * data) { int ig = neighbor.i - point.i;  if (ig == 0) ig = _attribute[_s.i].d.x;  NOT_UNUSED(ig); int jg = neighbor.j - point.j;  if (jg == 0) jg = _attribute[_s.i].d.y;  NOT_UNUSED(jg); POINT_VARIABLES; 
#line 62 "wall_heat.c"
return  dirichlet_homogeneous(); return 0.; }
#line 64 "wall_heat.c"
...
return  dirichlet_homogeneous(); return 0.; }
#line 66 "wall_heat.c"
static double _boundary10 (Point point, Point neighbor, scalar _s, void * data) { int ig = neighbor.i - point.i;  if (ig == 0) ig = _attribute[_s.i].d.x;  NOT_UNUSED(ig); int jg = neighbor.j - point.j;  if (jg == 0) jg = _attribute[_s.i].d.y;  NOT_UNUSED(jg); POINT_VARIABLES; 
#line 65 "wall_heat.c"
return  neumann(0.1*exp(-sq(x))/(5e-3)); return 0.; } static double _boundary10_homogeneous (Point point, Point neighbor, scalar _s, void * data) { int ig = neighbor.i - point.i;  if (ig == 0) ig = _attribute[_s.i].d.x;  NOT_UNUSED(ig); int jg = neighbor.j - point.j;  if (jg == 0) jg = _attribute[_s.i].d.y;  NOT_UNUSED(jg); POINT_VARIABLES; 
#line 65 "wall_heat.c"
return  neumann_homogeneous(); return 0.; }
#line 72 "wall_heat.c"
static double _boundary11 (Point point, Point neighbor, scalar _s, void * data) { int ig = neighbor.i - point.i;  if (ig == 0) ig = _attribute[_s.i].d.x;  NOT_UNUSED(ig); int jg = neighbor.j - point.j;  if (jg == 0) jg = _attribute[_s.i].d.y;  NOT_UNUSED(jg); POINT_VARIABLES; 
#line 71 "wall_heat.c"
return  dirichlet (9.81/273.*y*0.3); return 0.; } static double _boundary11_homogeneous (Point point, Point neighbor, scalar _s, void * data) { int ig = neighbor.i - point.i;  if (ig == 0) ig = _attribute[_s.i].d.x;  NOT_UNUSED(ig); int jg = neighbor.j - point.j;  if (jg == 0) jg = _attribute[_s.i].d.y;  NOT_UNUSED(jg); POINT_VARIABLES; 
#line 71 "wall_heat.c"
return  dirichlet_homogeneous(); return 0.; }
